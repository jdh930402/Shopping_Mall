...
@Controller
public class ChamudeController {
	...
	// chamude 페이지로 전송
	@RequestMapping(value = "chamude", method = RequestMethod.GET)
	public ModelAndView getMoveProcess(@RequestParam(defaultValue = "1", name = "page")int page) {
		ModelAndView modelAndView = new ModelAndView();
		pagination.paginationSetting(page, 12, 10, productInter.countChamudeAll());
		ArrayList<ProductDto> list = productInter.chamudePaging(pagination);
