...
public class PayDto {
	private String order_num, pay_no, user_id, prd_num, pay_name, pay_tel, pay_zipcode, pay_loc, pay_loc_detail,
			pay_price, pay_quantity, pay_regdate, pay_credit, pay_memo, pay_deli;
	private String prd_name, prd_no, prd_msr, prd_quantity, prd_price, img_header, img_description, img_option;
